									...
									<li :style="widthHead1[5]"  >	
											<el-dropdown trigger="click" placement="bottom-end" size="mini">
												...
												<el-dropdown-menu slot="dropdown">
													<el-dropdown-item >
														<span style="display: flex;align-items: center;" @click="songeStateFilterHandler()">
													...
													<el-dropdown-item>
														<span style="display: flex;align-items: center;"  @click="songeStateFilterHandler(3)">
													...
													<el-dropdown-item >
														<span style="display: flex;align-items: center;" @click="songeStateFilterHandler(1)">
													...
													<el-dropdown-item >
														<span style="display: flex;align-items: center;" @click="songeStateFilterHandler(2)">
													...
													<el-dropdown-item >
														<span style="display: flex;align-items: center;" @click="songeStateFilterHandler(4)">
  ...
  export default {
    ...
    methods: {
			timeFilterOk(){
				  var _this = this
				  var arr = [] 
					this.filterTableData.map(function(item){
						     for(var i = 0; i<_this.checkList.length;i++){
									 console.log(item.filterData)
									   if(item.filterData == _this.checkList[i]){
											   arr.push(item) 
												 return;
										 }
								 }
      ...
      handleSelectionChange(val) {
		...
		songeStateFilterHandler(n){
			  if(n){
				var arr = this.filterTableData.filter(function(item){
						    if(item.songState == n){
									return item
								}
					}) 
